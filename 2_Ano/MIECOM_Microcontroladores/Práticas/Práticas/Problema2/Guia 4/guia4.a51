...
LOOP:SETB	P1.3
        MOV 	C,P3.3	; move para acumulador "c" o valor binário(0 ou 1) recbido de P3.3
		ORL		C,P3.5	; operação logica OR do acumulador "c" com o valor binário(0 ou 1) recbido de P3.5
		MOV		P1.2,C	; mov para P1.2 o valor binário(0 ou 1) recbido de "c"
		JMP	LOOP	; salto para endereço absoluto "LOOP"
