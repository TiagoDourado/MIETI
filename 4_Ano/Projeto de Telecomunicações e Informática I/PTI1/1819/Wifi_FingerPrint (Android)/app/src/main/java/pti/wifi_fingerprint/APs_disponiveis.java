...
public class APs_disponiveis extends AppCompatActivity {
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.nav_first_fragment:
                Intent intent=new Intent(APs_disponiveis.this, entrar_num_espaco.class);
                startActivity(intent);
                break;
            case R.id.nav_second_fragment:
                Intent intent2=new Intent(APs_disponiveis.this, definicoes.class);
                startActivity(intent2);
                break;
            default:
            case R.id.nav_third_fragment:
                Intent intent3=new Intent(APs_disponiveis.this, MainActivity.class);
