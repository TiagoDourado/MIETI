 ...
 * @author andre
 */
public class ViewalertController implements Initializable {
    ...
    @FXML
    private TextArea respostaviewalerta;
    ...
    @FXML
    private void sendviewalert(ActionEvent event) throws IOException, NoSuchAlgorithmException, KeyManagementException {
