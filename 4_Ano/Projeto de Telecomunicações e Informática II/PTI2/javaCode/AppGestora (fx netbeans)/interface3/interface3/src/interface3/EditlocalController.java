 ...
 * @author andre
 */
public class EditlocalController implements Initializable {
    ...
    @FXML
    private TextArea respostaeditlocal;
    ...
    @FXML
    private void sendeditlocal(ActionEvent event) throws IOException, NoSuchAlgorithmException, NoSuchAlgorithmException, KeyManagementException {
        
  
    ArrayList<String> User = new ArrayList<>();
        String[] trama = new String[5] ;
        trama[0]= "editLocal";
        trama[1]= id.getText();
        trama[2]= nome.getText();
        trama[4]= ip.getText();
        trama[3]= cover.getText();
