...
public class AdduserController implements Initializable {
    ...
    @FXML
    private TextField dataaniv;
    @FXML
    private TextArea respostaadduser;
    @FXML
   ...
   @Override
    ...
    @FXML
    private void sendadduser(ActionEvent event) throws IOException, NoSuchAlgorithmException, KeyManagementException, KeyManagementException {
                     ArrayList<String> User = new ArrayList<>();
                String[] trama = new String[8] ;

   
                trama[0]= "addUser";
                trama[1]= nome.getText();
                trama[2]= tipo.getText();
                trama[3]= username.getText();
                trama[4]= email.getText();
                trama[5]=pass.getText();
                trama[6]= morada.getText();
                trama[7]= dataaniv.getText();
