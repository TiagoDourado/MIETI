 ...
 * @author pedro
 */
public class RmuserController implements Initializable {
    ...
    @FXML
    private TextArea respostarmuser;
    ...
    @FXML
    private void sendrmuser(ActionEvent event) throws IOException, NoSuchAlgorithmException, NoSuchAlgorithmException, KeyManagementException {
