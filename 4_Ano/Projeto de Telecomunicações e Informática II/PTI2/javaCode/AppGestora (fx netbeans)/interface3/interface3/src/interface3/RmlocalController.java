 ...
 * @author andre
 */
public class RmlocalController implements Initializable {

    @FXML
    private AnchorPane root;
    @FXML
    private TextField id;
    private TextArea respostarmalerta;
    @FXML
    private TextArea respostarmlocal;
    ...
    @FXML
    private void sendrmlocal(ActionEvent event) throws IOException, NoSuchAlgorithmException, KeyManagementException, KeyManagementException {
        ...
        alert.setContentText("Tem a certeza que pretende remover?");
