 ...
 * @author andre
 */
public class RmalertController implements Initializable {
    ...
    @FXML
    private void sendrmalert(ActionEvent event) throws IOException, NoSuchAlgorithmException, KeyManagementException {
      ...
      Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
        ...
        alert.setContentText("Tem a certeza que pretendia pretende remover?");
