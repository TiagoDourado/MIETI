 ...
 * @author andre
 */
public class ViewalllocalController implements Initializable {

    @FXML
    private AnchorPane root;
    @FXML
    private ScrollPane todoslocais;
    ...
    @FXML
    private void sendviewalllocal(ActionEvent event) throws IOException, NoSuchAlgorithmException, KeyManagementException {
