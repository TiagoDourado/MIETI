 ...
 * @author andre
 */
public class ViewallalertController implements Initializable {

    @FXML
    private AnchorPane root;
    @FXML
    private ScrollPane alertas;
    ...
    @FXML
    private void sendviewallalerts(ActionEvent event) throws IOException, KeyManagementException, NoSuchAlgorithmException {
