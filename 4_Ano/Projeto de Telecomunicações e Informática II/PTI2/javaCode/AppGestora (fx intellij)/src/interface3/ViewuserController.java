...
public class ViewuserController implements Initializable {
    ...
    @FXML
    private TextArea respostaviewuser;
    ...
    @FXML
    private void sendviewuser(ActionEvent event) throws IOException, NoSuchAlgorithmException, KeyManagementException, KeyManagementException {
