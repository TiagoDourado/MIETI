        ...
        try {
            while ((transmissao = in.readLine()) != null) {
                ...
                if (Tipo_trama.equals("editAlerta")) {
                    ...
                    String hora2 = trama[4];
                    String state2 = trama[5];
                    String ip_origem2 = trama[6];
                    String ip_rsu2 = trama[7];
                    String local2 = trama[8];
                    String tipo = trama[9];
                    String user2 = trama[10];
                ...
                if (Tipo_trama.equals("Login")) {
                    ...
                    DBCentral db = new DBCentral();
                    String res = db.login(email, pass_raw);
                    out.println(res);
